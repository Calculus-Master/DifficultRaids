...
@OnlyIn(Dist.CLIENT)
public class ElectroIllagerRenderer extends IllagerRenderer<ElectroIllagerEntity>
{
    private static final ResourceLocation ELECTRO_ILLAGER = new ResourceLocation("textures/entity/illager/evoker.png");
    ...
    public ElectroIllagerRenderer(EntityRendererProvider.Context entityRenderProvider)
    {
        ...
        {
            @Override
            public void render(PoseStack p_116352_, MultiBufferSource p_116353_, int p_116354_, ElectroIllagerEntity p_116355_, float p_116356_, float p_116357_, float p_116358_, float p_116359_, float p_116360_, float p_116361_)
            {
