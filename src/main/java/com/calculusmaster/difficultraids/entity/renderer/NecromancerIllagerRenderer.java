...
public class NecromancerIllagerRenderer extends IllagerRenderer<NecromancerIllagerEntity>
{
    ...
    public NecromancerIllagerRenderer(EntityRendererProvider.Context entityRenderProvider)
    {
        ...
        {
            @Override
            public void render(PoseStack p_116352_, MultiBufferSource p_116353_, int p_116354_, NecromancerIllagerEntity p_116355_, float p_116356_, float p_116357_, float p_116358_, float p_116359_, float p_116360_, float p_116361_)
            {
    ...
    @Override
    public ResourceLocation getTextureLocation(NecromancerIllagerEntity p_115720_)
    {
        return NECROMANCER_ILLAGER;
    }
}
